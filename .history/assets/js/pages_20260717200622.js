...
if (curserOutline && !prefersReducedMotion && window.matchMedia('(pointer: fine)').matches) {
    ...
    document.addEventListener('pointerover', (e) => {
        const isInteractiveTarget = e.target && e.target.closest && e.target.closest(interactiveCursorTargets);
        curserOutline.classList.toggle('is-active', Boolean(isInteractiveTarget));
        curserOutline.classList.add('is-visible');
    });
